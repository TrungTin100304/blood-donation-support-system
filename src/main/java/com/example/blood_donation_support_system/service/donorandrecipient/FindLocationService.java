...
public interface FindLocationService {
    List<UserDto> findNearByDonors(double lat, double lng, double radiusKm, String bloodType);
//    List<UserEntity> findNearbyRecipients(double lat, double lng, double radiusKm);
}
